...
library TellorLibrary {
    ...
    */
        ...
        public
    {
        ...
        publicSubmitMiningSolution(self,_nonce);
        ...
        if (self.uintVars[keccak256("slotProgress")] == 5) {
                ...
                self.uintVars[keccak256("total_supply")] +=  self.uintVars[keccak256("currentReward")]*5 ;
    ...
    */
        ...
        public
    {
        ...
        for (uint j = 0; j < 5; j++) {
            require(_requestId[j] == self.currentMiners[j].value,"Request ID is wrong");
    ...
    function publicNewBlock(TellorStorage.TellorStorageStruct storage self) public{
    ...
    function publicSubmitMiningSolution(TellorStorage.TellorStorageStruct storage self,string memory _nonce) public{
                require(uint256(
